...
export default function AdminReports() {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        if (categoryFilter && ['best_sellers', 'worst_sellers', 'inventory', 'profit', 'low_stock'].includes(reportType)) {
          data = data.filter((r) => {
  ...
  const showCategoryFilter = ['best_sellers', 'worst_sellers', 'inventory', 'profit', 'low_stock'].includes(reportType);
