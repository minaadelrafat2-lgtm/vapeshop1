...
export default function Contact() {
  ...
  const submit = async (e: React.FormEvent) => {
    e.preventDefault();
    setBusy(true);
    // Store as a notification for the admin team
    ...
    <div className="section py-10">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mt-8">
        <div className="space-y-4">
          {[
            { icon: MapPin, title: 'Visit', lines: ['1 Liberty Plaza', 'New York, NY 10006'] },
            { icon: Phone, title: 'Call', lines: ['+1 (800) 585-2937', 'Mon–Fri, 9am–6pm EST'] },
            { icon: Mail, title: 'Email', lines: ['hello@luxe.co', 'support@luxe.co'] },
