...
Adds business logic that makes inventory synchronize automatically:
...
- create_stock_alert() / resolve_stock_alert() — stock alert lifecycle
- Views: inventory_valuation, branch_performance, supplier_outstanding, inventory_timeline, etc.
