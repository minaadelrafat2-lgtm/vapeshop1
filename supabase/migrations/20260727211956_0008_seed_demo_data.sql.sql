...
Populates the database with realistic demo data so the storefront and admin work end-to-end.
...
INSERT INTO branches (name, code, address, city, state, postal_code, country, phone, email, manager, opening_hours, is_active) VALUES
  ...
  ('LUXE Miami Beach', 'MIA-04', '1100 Ocean Drive', 'Miami Beach', 'FL', '33139', 'United States', '+1 (305) 555-0156', 'miami@luxe.co', 'Carlos Mendez', '{"Monday":"10:00-22:00","Tuesday":"10:00-22:00","Wednesday":"10:00-22:00","Thursday":"10:00-22:00","Friday":"10:00-23:00","Saturday":"10:00-23:00","Sunday":"11:00-21:00"}', true)
...
-- SUPPLIERS (no unique constraint on name — guard with NOT EXISTS)
...
-- STORE LOCATIONS (no unique constraint — guard with NOT EXISTS)
...
-- FAQ (no unique constraint — guard with NOT EXISTS)
