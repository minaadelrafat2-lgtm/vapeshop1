...
then recreates them with fixes. All other DDL (indexes, constraints, policies)
is handled in the main migration.
*/

-- Drop functions that need signature/return changes
